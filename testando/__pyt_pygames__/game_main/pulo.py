...
#CAMINHO_IMAGEM_HAUNTER = "testando/__pyt_pygames__/.vscode/"

LARGURA, ALTURA = 800, 600
tela = pygame.display.set_mode((LARGURA, ALTURA))
bg = pygame.image.load("__pyt_pygames__/game_main/haunter.jpg").convert_alpha()

telainicio.Tela_inicio(tela, bg)
